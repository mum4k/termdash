...
func TestKeyboardKeys(t *testing.T) {
	tests := []struct {
		...
		{key: tcell.KeyRune, ch: ')', want: ')'},
		{key: tcell.Key('1'), want: '1'},
		{key: tcell.Key('2'), want: '2'},
		{key: tcell.Key('9'), want: '9'},
		{key: tcell.Key('d'), want: 'd'},
		...
		{key: tcell.KeyUpLeft, want: keyboard.KeyHome},
		{key: tcell.KeyUpRight, want: keyboard.KeyPgUp},
		{key: tcell.KeyDownLeft, want: keyboard.KeyEnd},
		{key: tcell.KeyDownRight, want: keyboard.KeyPgDn},
		{key: tcell.KeyCenter, want: keyboard.Key('5')},
		{key: tcell.KeyClear, want: keyboard.Key('5')},
